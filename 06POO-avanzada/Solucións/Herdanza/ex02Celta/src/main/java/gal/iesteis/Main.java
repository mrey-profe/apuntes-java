...
public class Main {
    public static void main(String[] args) {
        ...
        Celtista c2 = new Celtista(LocalDate.of(2010, 9, 3), "Elena", LocalDate.of(1990, 1, 1));
        ...
        try {
            ...
            Abonado a = new Abonado("María", LocalDate.of(1995, 5, 5), abono);
            System.out.println(a);
            a.acumularSaldo(10);
            System.out.println("Prezo anual: " + a.calcularPrezoAnual());
            Equipo celta = new Equipo("Celta", 1923, "Balaídos", 30000);
            Abonado a1 = new Abonado("Pedro", LocalDate.of(1985, 3, 15), abono);
